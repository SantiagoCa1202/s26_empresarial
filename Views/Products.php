    ...
    <div class="row align-items">
      ...
      ?>
        ...
        <transition name="slide-fade">
          <s26-read-products v-model="action" :id="idRow" v-if="action == 'watch'">
          </s26-read-products>
        </transition>
      <?php
      }
      ...
      ?>
        <!-- Modal Nuevo-->
        <transition name="slide-fade">
          <s26-form-products v-model="action" :id="idRow" v-if="action == 'update'" @update="allRows"></s26-form-products>
        </transition>
      <?php
      }
      ?>
