...
<div id="s26-sales-view" class="container-fluid s26-container" tabindex="0">
  <?php
  ...
  <?php } else { ?>
    <div class="row align-items">
      <s26-sidebar title="Ventas" icon="shopping-bag" @update="allRows" @reset="onReset" v-model="activeSidebar" :url_export="url_export">
                  ...
                  <tr v-for="(sale, index) in item.items" :key="index" :class="sale.status == 3 ? 'tr-warning' : sale.status != 1 ? 'tr-danger' : ''">
                    ...
                    <td class="length-action text-center">
                      ...
                      <s26-dropdown v-if="sale.status != 2">
                        ...
                        ?>
                          <li class="list-group-item border-0" @click="setIdRow(sale.id, 'update')">
                            Editar
                          </li>
                        <?php
                        }
                        ...
                        ?>
                          <li class="list-group-item border-0" @click="cancelSale(sale)" v-if="sale.status == 1">
                            Anular
                          </li>
                        <?php
                        }
      ...
      ?>
        ...
        <transition name="slide-fade">
          <s26-read-sale v-model="action" :id="idRow" v-if="action == 'watch'">
          </s26-read-sale>
        </transition>
      <?php
      }
      ...
      ?>
        <!-- Modal Nuevo-->
        <transition name="slide-fade">
          <s26-form-sale v-model="action" :id="idRow" v-if="action == 'update'" @update="allRows"></s26-form-sale>
        </transition>
      <?php
      }
      ?>
